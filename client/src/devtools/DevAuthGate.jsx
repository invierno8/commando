...
export default function DevAuthGate({ route, devFabProps }) {
  ...
  // הרשאה נפרדת מ-isAdmin — יכולה להתקיים לבד, יחד עם isAdmin, או לא בכלל
  // (ראו FORCLAUDE.md). נשלפת מ-/dev/me, לא מ-/admin/me, כי כל משתמש-פיתוח
  // רגיל (לא רק admin) יכול לקבל אותה.
  ...
  return (
    <>
      <style>{CSS}</style>
      <DevOverlay active={overlayOn} route={route} isAdmin={isAdmin} canJynxComment={canJynxComment} />
