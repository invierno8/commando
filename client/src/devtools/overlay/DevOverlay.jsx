...
.dev-annotate-popover-admin-hint{
  font-size:12px; color:#2F8FCE; background:color-mix(in srgb, #2F8FCE 12%, transparent);
...
.dev-annotate-popover-jynx-hint{
  font-size:12px; color:var(--dev); background:color-mix(in srgb, var(--dev) 14%, transparent);
  border-radius:6px; padding:4px 8px;
}
.dev-annotate-popover-drawing-hint{
  font-size:12px; color:var(--jynx); background:color-mix(in srgb, var(--jynx) 12%, transparent);
  border-radius:6px; padding:4px 8px;
}
...
.dev-annotate-relogin-link{
  background:none; border:none; color:var(--dev); font-weight:700; font-size:12px; text-decoration:underline;
