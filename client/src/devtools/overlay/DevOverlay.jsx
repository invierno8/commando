...
.dev-annotate-action-toggle{
  ...
  background:none; color:var(--text-dim); border-radius:20px; padding:4px 10px; font-size:11.5px; font-weight:700;
...
.dev-annotate-picking-hint{
  font-size:12px; color:var(--dev); background:color-mix(in srgb, var(--dev) 10%, transparent);
